 ...
 * Valida as RPCs, o RLS e o modelo de dados de Grupos e da conta.
 */
import { createClient } from "@supabase/supabase-js";

const URL = "https://tpkshrvoyasqfmurqzok.supabase.co";
const KEY = "sb_publishable_TAJB_5qH36Z9WvPjRLIoIw_eNbOsIGE";
